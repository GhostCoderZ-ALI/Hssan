...
async def cmd_auth(message: types.Message):
    ...
    try:
        ...
        response = await run_sync(requests.post, 'https://api.stripe.com/v1/payment_methods', headers=headers, data=data, proxies=proxy_dict)
        ...
        vault_resp = await run_sync(requests.post, 'https://dermajem.com/', params=params, cookies=cookies, headers=headers2, data=data2, proxies=proxy_dict)
