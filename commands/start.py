...
_GATES_TEXT = (
    ...
    f"│  💳 <b>Stripe 2$</b>   <code>/st2 cc|mm|yy|cvv</code>\n"
    f"│  💎 <b>Braintree $5</b>  <code>/b3-5 cc|mm|yy|cvv</code>\n"
    f"│  💰 <b>PayFast $0.6</b>  <code>/pf0.6 cc|mm|yy|cvv</code>\n"
    f"│  💳 <b>Braintree Auth</b> <code>/b3n cc|mm|yy|cvv</code>\n"
    f"│  💵 <b>Stripe $15</b>    <code>/st15 cc|mm|yy|cvv</code>\n"
    f"│\n"
    f"│  All gates accept a <code>.txt</code> file for mass check\n"
    f"│  or use the <code>m</code> prefix: <code>/mpp /mstripe /mst</code>\n"
...
_FULL_HELP = (
    ...
    f"│  <code>/st2 cc|mm|yy|cvv</code>          Stripe Charged\n"
    f"│  <code>/b3-5 cc|mm|yy|cvv</code>         Braintree Charged\n"
    f"│  <code>/pf0.6 cc|mm|yy|cvv</code>        PayFast Charged\n"
    f"│  <code>/b3n cc|mm|yy|cvv</code>         Braintree New Auth\n"
    f"│  <code>/st15 cc|mm|yy|cvv</code>        Stripe $15\n"
