...
_GATES_TEXT = (
    ...
    f"│\n"
    f"│  💳 <b>Stripe Auth</b>     <code>/auth cc|mm|yy|cvv</code>\n"
    f"│  💳 <b>Stripe SI</b>       <code>/mst cc|mm|yy|cvv</code>\n"
    f"│  💳 <b>Stripe (legacy)</b> <code>/stripe cc|mm|yy|cvv</code>\n"
    f"│  💎 <b>Braintree 3D</b>    <code>/b3 cc|mm|yy|cvv</code>\n"
    f"│  💵 <b>PayPal $1</b>       <code>/pp cc|mm|yy|cvv</code>\n"
    f"│  🛒 <b>Shopify auto</b>    <code>/sh &lt;site&gt; cc|mm|yy|cvv</code>\n"
    f"│  🛒 <b>Shopify direct</b>  <code>/chk &lt;site&gt; cc|mm|yy|cvv</code>\n"
    f"│  🌐 <b>Generic site</b>    <code>/hit &lt;site&gt; cc|mm|yy|cvv</code>\n"
    f"│  🅰️ <b>Address-DB</b>      <code>/adb &lt;country&gt;</code>\n"
    f"│\n"
    f"│  Mass mode for any gate: prefix <code>m</code>\n"
    f"│  e.g. <code>/mpp /mass-st /mchk</code>\n"
...
_FULL_HELP = (
    ...
    f"│\n"
    f"│  <b>★ Card gates</b>\n"
    f"│  <code>/auth cc|mm|yy|cvv</code>     Stripe Auth\n"
    f"│  <code>/stripe cc|mm|yy|cvv</code>   Stripe (legacy)\n"
    f"│  <code>/mst cc|mm|yy|cvv</code>      Stripe Setup-Intent\n"
    f"│  <code>/mass-st &lt;cards&gt;</code>      Mass Stripe SI\n"
    f"│  <code>/b3 cc|mm|yy|cvv</code>       Braintree 3D\n"
    f"│  <code>/pp cc|mm|yy|cvv</code>       PayPal $1\n"
    f"│  <code>/mpp &lt;cards&gt;</code>          Mass PayPal\n"
    f"│  <code>/sh &lt;site&gt; cc|mm|yy|cvv</code>  Shopify auto\n"
    f"│  <code>/chk &lt;site&gt; cc|mm|yy|cvv</code> Shopify direct\n"
    f"│  <code>/mchk &lt;site&gt; &lt;cards&gt;</code>  Mass Shopify\n"
    f"│  <code>/hit &lt;site&gt; cc|mm|yy|cvv</code>  Generic gate\n"
    f"│\n"
    f"│  <b>★ Tools</b>\n"
